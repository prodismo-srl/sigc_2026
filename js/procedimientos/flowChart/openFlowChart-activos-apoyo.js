...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/gestion-activos-apoyo.png';
    flowchartImage.alt = 'Flujo de Gestión Activos de Apoyo - Vista ampliada';
    ...
    imageCaption.textContent = 'Flujo de Gestión Activos de Apoyo';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="gestion-activos-apoyo.png"]');
