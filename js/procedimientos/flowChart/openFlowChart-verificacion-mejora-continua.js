...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/gestion-no-conformidades-flowchart.png';
    flowchartImage.alt = 'Flujo de Corrección de No Conformidades - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de flujo del proceso de Corrección de No Conformidades';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="gestion-no-conformidades-flowchart.png"]');
