...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../../images/iso9001/matriz-clasificacion-potencial-fallas.png';
    flowchartImage.alt = 'Matriz de Clasificación de Potencial de Fallos - Vista ampliada';
    ...
    imageCaption.textContent = 'Matriz de Clasificación de Potencial de Fallos';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="matriz-clasificacion-potencial-fallas.png"]');
