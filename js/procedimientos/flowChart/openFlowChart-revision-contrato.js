...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../../images/flow-diagrams/iso/P-7-01_Revisión-contrato-flujograma.jpg';
    flowchartImage.alt = 'Flujo de Revisión de Contrato - Vista ampliada';
    ...
    imageCaption.textContent = 'Flujo de Revisión de Contrato';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="P-7-01_Revisión-contrato-flujograma.jpg"]');
