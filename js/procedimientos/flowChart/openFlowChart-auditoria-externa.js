...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/proceso-auditoria-externa-flowchart.png';
    flowchartImage.alt = 'Flujo de Proceso Auditoría Externa Independiente - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de flujo de Proceso Auditoría Externa Independiente';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="proceso-auditoria-externa-flowchart.png"]');
