...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../../images/flow-diagrams/iso/P-7-08_Control-Equipos-Inspeccion-flujograma.jpg';
    flowchartImage.alt = 'Flujo de Gestión de Respuesta ante Incidentes - Vista ampliada';
    ...
    imageCaption.textContent = 'Flujo de Gestión de Control de Equipos de Inspección y Ensayo';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="P-7-08_Control-Equipos-Inspeccion-flujograma.jpg"]');
