...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../../images/flow-diagrams/gestion-cambios.png';
    flowchartImage.alt = 'Flujo de Gestión de Cambios - Vista ampliada';
    ...
    imageCaption.textContent = 'Flujo de Gestión de Cambios';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="gestion-cambios.png"]');
