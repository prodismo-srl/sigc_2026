...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/flujo-monitoreo-flowchart.png';
    flowchartImage.alt = 'Flujo de Monitoreo de Capacitación - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de Flujo del proceso de Monitoreo de Capacitación';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="flujo-monitoreo-flowchart.png"]');
