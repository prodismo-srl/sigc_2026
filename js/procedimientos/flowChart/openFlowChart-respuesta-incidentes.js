...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/respuesta-incidentes.png';
    ...
    imageCaption.textContent = 'Flujo de Gestión de Respuesta ante Incidentes';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="respuesta-incidentes.png"]');
