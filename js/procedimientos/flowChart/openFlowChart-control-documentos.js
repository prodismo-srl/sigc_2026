...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../../images/flow-diagrams/iso/P-4-01_Flow-chart.png';
    flowchartImage.alt = 'Flujo de Control de Documentos - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de Flujo del Proceso de Control de Documentos';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="P-4-01_Flow-chart.png"]');
