...
function openFlowchartModal() {
    ...
    imageCaption.textContent = 'Flujograma del proceso de cumplimiento de disposiciones reglamentarias';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="cumplimiento-disposiciones-reglamentarias.png"]');
