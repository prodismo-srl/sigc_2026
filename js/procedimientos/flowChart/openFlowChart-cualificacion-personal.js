...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/cualificacion-personal-flowchart.png';
    flowchartImage.alt = 'Flujo de Proceso de Cualificación Personal en Áreas Sensibles - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de flujo del Proceso de Cualificación Personal en Áreas Sensibles';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="cualificacion-personal-flowchart.png"]');
