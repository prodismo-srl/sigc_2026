...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../../images/flow-diagrams/gestion-accesos.png';
    flowchartImage.alt = 'Flujo de Gestión de Accesos - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de Flujo de Gestión de Accesos';
...
function openImageModal() {
    // Crear elementos del modal
    const modalOverlay = document.createElement('div');
    modalOverlay.id = 'zonas-seguridad-image';
    modalOverlay.style.cssText = `
        position: fixed;
        top: 0;
        left: 0;
    ...
    const flowchartImage = document.createElement('img');
    flowchartImage.src = '../../../../images/seguridad-fisica/Zonas-seguridad1.png';
    flowchartImage.alt = 'Zonas de Seguridad';
    flowchartImage.style.cssText = `
        max-width: 100%;
        height: auto;
        cursor: zoom-in;
    ...
    const imageCaption = document.createElement('p');
    imageCaption.textContent = 'Zonas de Seguridad';
    imageCaption.style.cssText = `
        text-align: center;
        margin-top: 15px;
        color: #666;
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="gestion-accesos.png"]');
...
function initImageModal() {
    // Buscar la imagen existente en el documento
    const existingImage = document.querySelector('img[src*="Zonas-seguridad1.png"]');

    if (existingImage) {
        // Agregar funcionalidad de clic a la imagen existente
        existingImage.style.cursor = 'pointer';
        existingImage.title = 'Haz clic para ver en tamaño completo';
        existingImage.addEventListener('click', openImageModal);
        ...
        const openModalButton = document.createElement('button');
        openModalButton.textContent = 'Ver imagen en tamaño completo';
        openModalButton.style.cssText = `
            background: #3b82f6;
            color: white;
            border: none;
        ...
        openModalButton.addEventListener('click', openImageModal);
