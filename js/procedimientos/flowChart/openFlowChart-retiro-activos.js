...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/retiro-seguro-activos-externos.png';
    flowchartImage.alt = 'Diagrama de Flujo del proceso de Retiro de Activos - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de Flujo del proceso de Retiro de Activos';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="retiro-seguro-activos-externos.png"]');
