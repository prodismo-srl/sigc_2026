...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/flujo-monitoreo-red.png';
    flowchartImage.alt = 'Flujo de general del proceso de monitorización y respuesta - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de Flujo de general del proceso de monitorización y respuesta';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="flujo-monitoreo-red.png"]');
