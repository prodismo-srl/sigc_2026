...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/respuesta-situaciones-excepcionales.png';
    flowchartImage.alt = 'Flujo de Respuesta ante Situaciones Excepcionales - Vista ampliada';
    ...
    imageCaption.textContent = 'Flujo de Respuesta ante Situaciones Excepcionales';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="respuesta-situaciones-excepcionales.png"]');
