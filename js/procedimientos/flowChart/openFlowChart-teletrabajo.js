...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/flujo-autorizacion-teletrabajo.png';
    flowchartImage.alt = 'Flujo de Autorización de Teletrabajo - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de Flujo de Autorización de Teletrabajo';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="flujo-autorizacion-teletrabajo.png"]');
