...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/gestion-identidad.png';
    flowchartImage.alt = 'Flujo de Gestión de Identidad - Vista ampliada';
    ...
    imageCaption.textContent = 'Flujo de Gestión de Identidad';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="gestion-identidad.png"]');
