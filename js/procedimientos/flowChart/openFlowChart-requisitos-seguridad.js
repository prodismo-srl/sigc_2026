...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/requisitos-seguridad-flowchart.png';
    flowchartImage.alt = 'Flujo del proceso de seguridad en proyectos - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de flujo del proceso de incorporación de requisitos de seguridad en proyectos';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="requisitos-seguridad-flowchart.png"]');
