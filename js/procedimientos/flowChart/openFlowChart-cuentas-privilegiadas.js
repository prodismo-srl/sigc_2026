...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/acceso-just-in-time.png';
    flowchartImage.alt = 'Flujo de Gestión de Acceso Just-In-Time Cuentas Privilegiadas - Vista ampliada';
    ...
    imageCaption.textContent = 'Flujo de Gestión de Acceso Just-In-Time Cuentas Privilegiadas';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="acceso-just-in-time.png"]');
