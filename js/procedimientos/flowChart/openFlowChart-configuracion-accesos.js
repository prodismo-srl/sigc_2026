...
function openFlowchartModal() {
    ...
    flowchartImage.src = '../../../images/flow-diagrams/configuracion-accesos-flowchart.png';
    flowchartImage.alt = 'Flujo de Configuración de Accesos - Vista ampliada';
    ...
    imageCaption.textContent = 'Diagrama de flujo de Configuración de Accesos';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="configuracion-accesos-flowchart.png"]');
